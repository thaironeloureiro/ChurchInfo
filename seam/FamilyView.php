...
<td width="25%" valign="top" align="center">
	...
	<?php
		...
		echo "<font size=\"4\"><b>" . gettext("Family") . " $fam_Name "  . "</b></font>";
		echo "<br><br>";
		...
		echo "<font size=\"3\">";
			...
			if ($fam_Latitude && $fam_Longitude) {
				if ($nChurchLatitude && $nChurchLongitude) {
					...
					echo $sDistance . " " . strtolower($sDistanceUnit) . " " . $sDirection . " da Igreja<br>";
				}
			}
		echo "</font></div>";
			...
			if ($bOkToEdit) {
                ...
                echo '
                    ...
                    value="' . gettext("Upload Photo") . '" name="UploadPhoto">
									...
									echo "<a href=\"foto_familia/index.php?cod=$iFamilyID\" target='_blank'>Tirar Foto via Webcam</a>";	
			}
		}
	?>
	</div>
