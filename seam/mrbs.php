...
echo "<object data=$sMRBSPath/day.php width=100% height=1024> <embed src=$sMRBSPath/day.php width=100% height=1024> </embed> Error: Embedded data could not be displayed. </object>";
