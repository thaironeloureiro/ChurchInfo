$(document).ready(function(){
	...
	var template = '<a href="../Images/Person/{src}" rel="cam" '
		+'style="background-image:url(../Images/Person/thumbnails/{src})"></a>';
	...
	webcam.set_api_url('upload.php?cod='+cod);	// The upload script
