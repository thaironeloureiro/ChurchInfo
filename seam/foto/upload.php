...
//	unlink($original);
//	unlink('../Images/Person/thumbnails/'.$filename);
//	exit;
//}
...
rename($original,'../Images/Person/'.$filename);
$original = '../Images/Person/'.$filename;
...
if(is_file('../Images/Person/thumbnails/'.$filename))	
	unlink('../Images/Person/thumbnails/'.$filename);

//imagejpeg($newImage,'uploads/thumbs/'.$filename);
imagejpeg($newImage,'../Images/Person/thumbnails/'.$filename);
