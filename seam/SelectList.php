...
if ($iMode == 1 || $iMode == 2) {
    ...
    switch($sSort) {
        case "family":
                ...
                break;
        case "zip":
                $sOrderSQL = " ORDER BY zip,  per_FirstName, per_MiddleName,per_LastName";
                break;
        case "entered":
        ...
        case "edited";
                ...
                break;
				case "sobrenome";
                $sOrderSQL = " ORDER BY per_LastName, per_MiddleName, per_FirstName";
                break;	
				case "name";
                $sOrderSQL = " ORDER BY per_FirstName, per_MiddleName, per_LastName";
                break;							
        default:
                $sOrderSQL = " ORDER BY per_FirstName, per_MiddleName, per_LastName";
                break;
    ...
    if (!$bPrintView) {
        ...
        <select name="Sort" onchange="this.form.submit()">
                <option value="name" <?php if ($sSort == "name" || empty($sSort)) echo "selected";?>><?php echo gettext("By Name"); ?></option>
								<option value="sobrenome" <?php if ($sSort == "sobrenome" || empty($sSort)) echo "selected";?>><?php echo gettext("By Last Name"); ?></option>
...
**********************/
    ...
    switch($sSort) {
        case "entered":
            ...
            break;
										//case "sobrenome":
        //    $sSQL = $sSQL . " ORDER BY per_FirstName";
        //    break;	
				case "nome":
